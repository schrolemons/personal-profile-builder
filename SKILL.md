...
- display包含version（默认"2.0"）和update_date（默认当前年份，如2026年生成则填"2026"，无需用户指定）
...
**Footer 规则：**
footer 只应包含**重要信息**：蓝名直达链接、个人主页/个人简历链接等关键网址，以及一句结束语。**不要**在 footer 中出现次要信息，如"我在用XX和YY音乐软件"、"平时爱喝奶茶"等日常琐碎——这些应放在 friendship 板块的对应 block 中。footer中绝对不要出现secret_word。
...
2. **头像描述** — alt 文本
3. **暗号词（secret word）** — 好友添加时的验证关键词，默认可设为用户的 cn + 年份（如"猫猫2026"）。secret_word会被自动强化，不需要再使用highlight())处理。
...
| ---- | -------------- | ------------ | ----------- | ------------ | ----------- |
| 1    | 海洋蓝（推荐） | `#3b82f6`  | `#06b6d4` | `#8b5cf6`  | `#a855f7` |
...
| 编号 | 套组名称 | 白天 Primary | 白天 Accent | 夜间 Primary | 夜间 Accent |
| ---- | -------- | ------------ | ----------- | ------------ | ----------- |
| 1    | 海洋蓝   | `#3b82f6`  | `#06b6d4` | `#8b5cf6`  | `#a855f7` |
| 2    | 森林绿   | `#10b981`  | `#34d399` | `#059669`  | `#6ee7b7` |
| 3    | 日落橙   | `#f97316`  | `#fbbf24` | `#ea580c`  | `#facc15` |
| 4    | 樱花粉   | `#ec4899`  | `#f472b6` | `#be185d`  | `#f9a8d4` |
| 5    | 薰衣草紫 | `#8b5cf6`  | `#c084fc` | `#7c3aed`  | `#e9d5ff` |
